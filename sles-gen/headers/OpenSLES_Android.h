...
#define SL_ANDROID_PCM_REPRESENTATION_SIGNED_INT (0x00000001)
#define SL_ANDROID_PCM_REPRESENTATION_UNSIGNED_INT (0x00000002)
...
#define SL_ANDROID_SPEAKER_NON_POSITIONAL (0x80000000)
...
#define SL_ANDROID_SPEAKER_USE_DEFAULT (0)
...
#define SL_ANDROID_ITEMKEY_NONE (0x00000000)
#define SL_ANDROID_ITEMKEY_EOS (0x00000001)
#define SL_ANDROID_ITEMKEY_DISCONTINUITY (0x00000002)
#define SL_ANDROID_ITEMKEY_BUFFERQUEUEEVENT (0x00000003)
#define SL_ANDROID_ITEMKEY_FORMAT_CHANGE (0x00000004)

#define SL_ANDROIDBUFFERQUEUEEVENT_NONE (0x00000000)
#define SL_ANDROIDBUFFERQUEUEEVENT_PROCESSED (0x00000001)
...
/** Addendum to Data locator macros  */
#define SL_DATALOCATOR_ANDROIDBUFFERQUEUE (0x800007BE)
